...
class OwnedContentProfile extends StatefulWidget {
  @override
  _OwnedContentProfileState createState() => _OwnedContentProfileState();
}

class _OwnedContentProfileState extends State<OwnedContentProfile> {
