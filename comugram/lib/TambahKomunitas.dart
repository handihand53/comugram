                                      ...
                                      if (formKey.currentState.validate()) {
                                        ...
                                        if (imgPick != null &&
                                          ...
                                          Komunitas kom = Komunitas(
                                              ...
                                              tanggalBuat: tgl);
                                          Joined join = Joined(
                                              uid: kom.owner, kom_id: kom.uid);
                                          Fs.InsertKomunitas(kom, owner, join);
                                          pD.hide();
                                          Navigator.pop(context);
                                        } else {
                                          showAlertDialog_Fail(context,
                                              'Belum ada data lengkap untuk ditampilkan ke sesama Komunitas');
                                        }
                                      }
                                    },
