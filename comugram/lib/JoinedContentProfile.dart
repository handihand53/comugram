...
class JoinedContentProfile extends StatefulWidget {
  @override
  _JoinedContentProfileState createState() => _JoinedContentProfileState();
}

class _JoinedContentProfileState extends State<JoinedContentProfile> {
